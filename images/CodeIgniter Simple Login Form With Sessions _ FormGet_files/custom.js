...
function dlv_loading() {
    ...
    jQuery("#loading_submit").append("<br/><span style='font-size:16px; font-weight:bold;'>Please wait. Sending you email with your download.</span></br><span style='font-size:14px; font-weight:bold;'>If you haven't received the email yet, please check your spam folder once and mark the email as not spam.</span><br/><br/>");
    ...
    jQuery(".meter > span").each(function () {
        ...
        setTimeout(function () {
             ...
             * mailget post
             */
            jQuery.post('https://www.formget.com/mailget/signups/subscribe/IjYxMiI_3D', subs_data, function (response) {
                if (response) {
                }
